...
all_data = read_parquet("data/Results/extended_data_figure_3/data_for_plot_toxicity_vs_bin.parquet")

all_data$social = factor(all_data$social, 
                    levels = c("Usenet","Facebook","Gab","Reddit","Telegram","Twitter","Voat","Youtube"))

p = ggplot(all_data, aes(x = lin_bin, 
                     y = mean_toxicity, 
...
pdf(file = "figures/extended_data_figure_3.pdf", width = 8, height = 4)   
