...
all_data_toxicity_vs_thread_size = read_parquet("data/Results/extended_data_figure_7/data_for_plot_toxicity_threads_by_bin_with_05.parquet")
...
all_data_correlation_participation_toxicity = read_parquet("data/Results/extended_data_figure_7/data_for_plot_correlations_05.parquet")
...
all_data_toxic_non_toxic = read_parquet("data/Results/extended_data_figure_7/data_for_plot_correlation_toxic_non_toxic_threads_05.parquet")
...
###########################
# Aggreagte all the plots #
###########################

pdf(file = "figures/extended_data_figure_7.pdf", width = 11, height = 11)

p1 / (p3 + p4) + (p2_short) + plot_layout(nrow = 3) + plot_annotation(tag_levels = list(c("(a)","(b)","(c)","(d)"))) +
