...
if (identical(social_to_work_with,
  ...
  write_parquet(all_data, "data/Results/extended_data_figure_1/data_for_plot_user_lifetime_distribution.parquet") 
  ...
  all_data_old = read_parquet("data/Results/extended_data_figure_1/data_for_plot_user_lifetime_distribution.parquet") %>%
