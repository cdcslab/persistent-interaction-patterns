...
# Imposta il percorso di lavoro globale per tutti i comandi RUN
ENV R_PROFILE_USER=/usr/local/lib/R/etc/Rprofile.site

# Imposta il percorso di lavoro all'interno del file di script R
...
# Imposta i permessi all'interno del container
